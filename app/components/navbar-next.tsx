        ...
        <Navbar isBordered className="py-1">
            ...
            <NavbarContent className="hidden sm:flex gap-7" justify="center">
                <NavbarItem isActive={pathname === "/dao"}>
                    <Link
                        href="/dao"
                        className={`transition-colors hover:text-foreground/80 ${pathname === "/dao" ? "text-foreground font-semibold font-extrabold" : "text-foreground/60"
                            } font-mono`}
                    >
                        DAO
                    </Link>
                ...
                <NavbarItem>
                    <Link
                        href="/profile"
                        className={`transition-colors hover:text-foreground/80 ${pathname === "/profile" ? "text-foreground font-semibold font-bold" : "text-foreground/60"
                            } font-mono`}
                    >
                        Profile
                    </Link>
                ...
                <NavbarItem>
                    <Link
                        href="/about"
                        className={`transition-colors hover:text-foreground/80 ${pathname === "/about" ? "text-foreground font-semibold font-bold" : "text-foreground/60"
                            } font-mono`}
                    >
                        About
                    </Link>
